...
class _FeedbackPageState extends State<FeedbackPage> {
  ...
  Future<void> exportPdfFile() async {
    ...
    html.AnchorElement(href: url)
      ..setAttribute("download", 'read-status-${feedback?.id}.pdf')
      ..click();
  ...
  Future<void> shareSubmitResponse(FeedbackData feedback) async {
    var anchorElement = html.AnchorElement(
      href:
          'mailto:Muthu.Manjunathan@goltens.com?subject=Submitted Feedback Form Of SERIAL ID: ${feedback.id} (PDF)&body=ATTACH PDF FILE',
    );
  ...
  Future<void> selectImage() async {
    ...
    if (feedback == null) {
      setState(() {
        filesArr.add({'file': result.files[0], 'type': FileType.image});
      });
    } else {
      setState(() {
        actionFilesArr.add({'file': result.files[0], 'type': FileType.image});
      });
    }
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Visibility(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 20),
                            feedback != null &&
                                    feedback?.feedbackAssignments.isEmpty ==
                                        true
                                      ...
                                      .map(
                                        (obj) => ListTile(
                                          leading: CircleAvatar(
                                            child: obj.user.avatar.isNotEmpty ==
                                                    true
                                                ? ClipRRect(
                                                    borderRadius:
                      ...
                      Visibility(
                        visible:
                            feedback?.feedbackAssignments.isNotEmpty == true
                                ? feedback?.feedbackAssignments[0]
                                        .assignmentCompleted ==
                                    true
                                : false,
                        child: Column(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              enabled:
                                  feedbackAssignment?.assignmentCompleted ==
                                      false,
                              keyboardType: TextInputType.multiline,
                              decoration: InputDecoration(
                            ...
                            Column(
                              children:
                                  actionFilesArr.mapIndexed((index, fileObj) {
                                return Column(
                                  mainAxisAlignment: MainAxisAlignment.start,
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
